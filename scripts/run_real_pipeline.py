...
def main() -> None:
    ...
    validate_job(job)
    final_state = build_real_graph(provider=BailianHappyHorseAdapter(), qa_agent=RealVideoQAAgent(evaluator=OpenAICompatibleVisionEvaluator())).invoke({"job": job, "events": []})
